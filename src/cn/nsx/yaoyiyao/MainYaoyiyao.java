...
public class MainYaoyiyao extends Activity {
	
	public static MainYaoyiyao instance = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        one = displayWidth/4; //设置水平动画平移大小(1/4)
        two = one*2;
        three = one*3;
        ...
        View view1 = mLi.inflate(R.layout.main_tab_dowhat, null);
        View view2 = mLi.inflate(R.layout.main_tab_res, null);
        View view3 = mLi.inflate(R.layout.main_tab_play, null);
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			mTabImg.startAnimation(animation);//mTabImg：底部绿色imageView的移动
		}
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {  //获取 back键
        	...
        	if(menu_display){         //如果 Menu已经打开 ，先关闭Menu
            	...
            	intent.setClass(MainYaoyiyao.this,Exit.class);
			...
			if(!menu_display){
				...
				mCloseBtn.setOnClickListener (new View.OnClickListener() {					
					...
					public void onClick(View arg0) {						
			        	...
			        	intent.setClass(MainYaoyiyao.this,Exit.class);
			        	startActivity(intent);
			        	menuWindow.dismiss(); //响应点击事件之后关闭Menu对话框
					}
				});				
				menu_display = true;				
			}else{
	...
	public void btnmainright(View v) {  
		Intent intent = new Intent (MainYaoyiyao.this,MainTopRightDialog.class);			
		startActivity(intent);	
	...
	public void btn_shake(View v) {   //摇一摇干什么
		Intent intent = new Intent (MainYaoyiyao.this,ShakeActivity.class);
		intent.putExtra("message", "dowhat");
		startActivity(intent);	
	}
	public void btn_shake1(View v) {   //摇一摇来首音乐
		Intent intent = new Intent (MainYaoyiyao.this,ShakeActivity.class);
		intent.putExtra("message", "music");
		startActivity(intent);	
	}
	public void btn_shake2(View v) {   //摇一摇笑话一集
		Intent intent = new Intent (MainYaoyiyao.this,ShakeActivity.class);	
		intent.putExtra("message", "xiaohua");
		startActivity(intent);	
	}
	public void btn_shake3(View v) {   //摇一摇搞笑Gif
		Intent intent = new Intent (MainYaoyiyao.this,ShakeActivity.class);
		intent.putExtra("message", "gif");
		startActivity(intent);	
	}
	...
	public void btn_shake5(View v) {   //摇一摇手电筒
		Intent intent = new Intent (MainYaoyiyao.this,ShakeLight.class);
